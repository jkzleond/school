...
define ('PSCWS4_DEFAULT_DICT_PATH', dirname(__FILE__).DIRECTORY_SEPARATOR.'etc/dict.utf8.xdb');

define ('PSCWS4_DEFAULT_RULE_PATH', dirname(__FILE__).DIRECTORY_SEPARATOR.'etc/rules.ini');
...
{	
	...
	// FOR PHP5
	function __construct($charset='gbk') { $this->CPSCWS4($charset); }
	...
	// ���ôʵ�
	function set_dict($fpath=PSCWS4_DEFAULT_DICT_PATH)
	{
		$xdb = new XDB_R;
	...
	// ���ù���
	function set_rule($fpath=PSCWS4_DEFAULT_RULE_PATH)
	{
